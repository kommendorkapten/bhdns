 ...
 */
size_t bhd_dns_h_unpack(struct bhd_dns_h*, const char*);
 ...
 */
size_t bhd_dns_q_section_unpack(struct bhd_dns_q_section*, const char*);
...
/* Internal functions */
size_t bhd_dns_q_unpack(struct bhd_dns_q*, const char*);
#endif /* __BHD_DNS_H__ */
